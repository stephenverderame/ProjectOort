...
pub fn load_texture_2d<F: glium::backend::Facade>(
    path: &str,
    facade: &F,
...
/*
pub fn load_texture_2d_rev<F : glium::backend::Facade>(path: &str, facade: &F)
    -> glium::texture::Texture2d
{
    let tex = load_img(path, true);
...
pub fn load_texture_hdr<F: glium::backend::Facade>(
    path: &str,
    facade: &F,
) -> glium::texture::Texture2d {
...
pub fn load_tex_2d_or_hdr<F: glium::backend::Facade>(
    path: &str,
    facade: &F,
) -> glium::texture::Texture2d {
...
#[allow(dead_code)]
pub fn load_cubemap<F>(file: &str, facade: &F) -> glium::texture::Cubemap
where
    F: glium::backend::Facade,
{
    ...
    for (name, cube_layer) in faces {
        let fbo = glium::framebuffer::SimpleFrameBuffer::new(
            facade,
...
pub fn gen_cloud_noise_vol<F: glium::backend::Facade>(
    width: u32,
    height: u32,
    depth: u32,
    facade: &F,
